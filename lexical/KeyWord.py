...
class SQLCommonKeyWord(Enum):
    ...
    LEFT_PARENTHESIS = ("(", {"is_special_char": 1})
    RIGHT_PARENTHESIS = (")", {"is_special_char": 1, "is_operator": 1})
    ...
    OR = ("OR", {"is_operator": 1})
    BY = ("BY", {})
    MAX = ("MAX", {"is_function": 1})
    MIN = ("MIN", {"is_function": 1})
    SIN = ("SIN", {"is_function": 1})
    COS = ("COS", {"is_function": 1})
    TAN = ("TAN", {"is_function": 1})
    ARCSIN = ("ARCSIN", {"is_function": 1})
    ARCCOS = ("ARCCOS", {"is_function": 1})
    ARCTAN = ("ARCTAN", {"is_function": 1})
    ABS = ("ABS", {"is_function": 1})
    LN = ("LN", {"is_function": 1})
    LG = ("LG", {"is_function": 1})
    VARCHAR = ("VARCHAR", {"is_datatype": 1})
    DESC = ("DESC", {})
    ASC = ("ASC", {})
    ADD = ("+", {"is_special_char": 1})
    SUB = ("-", {"is_special_char": 1})
    DIV = ("/", {"is_special_char": 1})
    POW = ("^", {"is_special_char": 1})
